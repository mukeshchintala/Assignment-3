...
// });
const password = 'Mukesh$8500';

// Replace 'Login' with your actual database name
const dbName = 'Login';

// MongoDB connection string with username, password, and database name

// Construct the MongoDB connection string
// const connectionString = `mongodb+srv://mukeshchintala1998:${encodeURIComponent(password)}@cluster0.urdgb83.mongodb.net/test?retryWrites=true&w=majority`;
// const dbName = 'YOUR_DATABASE';

// Construct the MongoDB connection string
const connectionString = `mongodb+srv://mukeshchintala1998:${encodeURIComponent(password)}@cluster0.urdgb83.mongodb.net/${dbName}`;
